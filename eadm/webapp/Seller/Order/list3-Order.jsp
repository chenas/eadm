...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="13" background="Seller/skin/images/tbg.gif">&nbsp;已完成订单列表&nbsp;</td>
</tr>
...
<s:if test="#request.pageList.map.isEmpty()==true">
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><s:property value="#key.status" /></td>
...
<td height="28" colspan="13">
	...
	<a href="javascript:" id="refreshNew3" class="coolbg" >&nbsp;刷新&nbsp;</a>
</td>
</tr>
