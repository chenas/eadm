...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><a id="edit" href="javacript:void(0);" >待定</a></td>
</tr>
...
<tr align="right" bgcolor="#EEF4EA">
			<td colspan="8" align="center">
				...
				<a href="myshop/listAll-Order?pageNo=1">第一页</a>&nbsp;&nbsp;
				<a href="myshop/listAll-Order?pageNo=${request.pageList.pageNumber-1}">上一页</a>
				</s:if>
				<s:else>
 				  已在第一页
				</s:else>
        			...
        			<s:iterator> 
             		  ...
             		  <s:else><a href="myshop/listAll-Order?pageNo=<s:property />"><s:property /></a></s:else>
             		  &nbsp;&nbsp;
     			   	</s:iterator>
      				</s:bean>
				<s:if test = "#request.pageList.pageNumber<#request.pageList.totalPage" >
				<a href="myshop/listAll-Order?pageNo=${request.pageList.pageNumber+1}">下一页</a>&nbsp;&nbsp;
				<a href="myshop/listAll-Order?pageNo=${request.pageList.totalPage }">末页</a>
				</s:if>
				<s:else>
   				末页
				</s:else>
