...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="85%" bgcolor="#FFFFFF">
									<select id="cat1"  name="cat1" onchange="createCategory()">
										<option value="<s:property value="#product.category.name" />">...请选择...</option>
									</select></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    ...
    <td width="85%" bgcolor="#FFFFFF">
									<select id="cat2" name="cat2" >
										<option value='<s:property value="#product.categorydetail.name" />'>...请选择...</option>
									</select></td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="85%" bgcolor="#FFFFFF">
									<input size="40" type="text" name="productVo.price" value="<s:property value="#product.price" />" />
									<input type="text" disabled value="请填写数字"/></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="15%" bgcolor="#FFFFFF">进&nbsp;价</td>
    <td width="85%" bgcolor="#FFFFFF">
									<input size="40" type="text" name="productVo.inprice" value="<s:property value="#product.inprice" />" />
									<input type="text" disabled value="请填写数字"/></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="15%" bgcolor="#FFFFFF">库存量</td>
    <td width="85%" bgcolor="#FFFFFF">
									<input size="40" type="text" name="productVo.kucunliang" value="<s:property value="#product.kucunliang" />" />
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="85%" bgcolor="#FFFFFF">
									<input size="40" type="text" name="productVo.cuxiaojia" value="<s:property value="#product.cuxiaojia" />" />
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <input type="submit" value="保   存" size="30" />
    </td>
  </tr>
</table>
</form>
